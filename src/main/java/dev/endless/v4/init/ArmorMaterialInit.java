...
public class ArmorMaterialInit {
    public static final RegistryEntry<ArmorMaterial> EXAMPLE = register("example", Map.of( // id: example -> Textures/models/armor/example_layer....
    ...
    public static RegistryEntry<ArmorMaterial> register(String id, Map<ArmorItem.Type, Integer> defensePoints,
        ...
        List<ArmorMaterial.Layer> layers = List.of(
                new ArmorMaterial.Layer(Noctyra.id(id), "", dyeable)
        );
        ...
        material = Registry.register(Registries.ARMOR_MATERIAL, Noctyra.id(id), material);
